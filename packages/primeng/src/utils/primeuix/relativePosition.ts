import { getCSSVariableByRegex, getHiddenElementDimensions, getViewport } from '@primeuix/utils';

export function relativePosition(element: HTMLElement, target: HTMLElement, gutter: boolean = true, fixedOrigin: 'top' | 'bottom' | undefined = undefined): void {
    if (element) {
